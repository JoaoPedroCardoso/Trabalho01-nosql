...
// Criando index para busca de projetos pelo nome:
//antes do index:
db.todolist.find({name: "Mental Health App Development"}).explain("executionStats")
...
[
  {
    ...
    "executionStats": {
      ...
      "executionStages": {
        ...
        "filter": {
          "name": {
            "$eq": "Mental Health App Development"
          }
        },
        "nReturned": 1,
...
//Criacao do index:
db.todolist.createIndex({"name": 1})
    ...
    "executionStats": {
      ...
      "executionStages": {
        ...
        "inputStage": {
          ...
          "direction": "forward",
          "indexBounds": {
            "name": ["[\"Mental Health App Development\", \"Mental Health App Development\"]"]
          },
          "keysExamined": 1,
          "seeks": 1,
          "dupsTested": 0,
